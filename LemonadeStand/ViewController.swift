...
//  LemonadeStand
//
//  Created by Brown Magic on 3/20/15.
...
class ViewController: UIViewController {
  ...
  @IBAction func unpurchaseLemonButtonPressed(sender: UIButton) {
    if lemonsToPurchase > 0 {
      ...
      showAlertWithText(message: "You have no lemons to sell")
    }
  }
  @IBAction func unpurchaseIceCubeButtonPressed(sender: UIButton) {
    if iceCubesToPurchase > 0 {
      ...
      showAlertWithText(message: "You have no ice cubes to sell")
    }
  }
  ...
  @IBAction func unmixLemonButtonPressed(sender: UIButton) {
    if lemonsToMix > 0 {
      ...
      showAlertWithText(header: "Warning", message: "You have nothing to unmix")
    }
  }
  ...
  @IBAction func startDayButtonPressed(sender: UIButton) {
    ...
    if lemonsToMix == 0 || iceCubesToMix == 0 {
      showAlertWithText(message: "You need to add at least one lemon and one ice")
    } else {
